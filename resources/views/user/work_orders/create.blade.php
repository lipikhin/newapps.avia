...
{{--                    <h5 class="modal-title" id="addInstructionModalLabel">{{ __('Add Scope') }}</h5>--}}
...
{{--                            <input type="text" class="form-control" id="instruction" name="instruction_id" required>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--    </div>--}}
    ...
    <script>
        ...
        {{--handleFormSubmission('addInstructionForm', '{{ route('user.instruction.store') }}', 'instruction_id', 'id',--}}
        {{--    'name',--}}
        {{--    'addInstructionModal');--}}
